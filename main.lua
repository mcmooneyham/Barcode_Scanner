...
-- title text
barCodeText = display.newText("BAR CODE READER SAMPLE\nClick on READ to read the bar code", 0,0, native.systemFontBold, 15)
...
local readerWidthText = display.newText("Reader width = " .. originalGuideWidth, 0,0, native.systemFontBold, 15)
...
local currentValue = display.newText("#Read: 3", 0,0, native.systemFontBold, 15)
